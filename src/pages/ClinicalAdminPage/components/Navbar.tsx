...
const pages: Page[] = [
    ...
    { name: 'Students', path: '/students', icon: <PeopleIcon fontSize="small" /> },
    { name: 'Requests', path: '/requests', icon: <ListAltIcon fontSize="small" /> },
    { name: 'Attendance', path: '/attendance', icon: <NotificationsNoneIcon fontSize="small" /> },
                            ...
                            <Box sx={{ width: 260, display: "flex", flexDirection: "column", height: "100%" }}>
                                ...
                                <List sx={{ flexGrow: 1, pl: 1.5 }}>
                                    <ListItem disablePadding>
                                        <ListItemButton onClick={() => navigate("/clinicalAdminStudents")}>
                                    ...
                                    <ListItem disablePadding>
                                        <ListItemButton onClick={() => navigate("/clinicalAdminRequests")}>
                                            <ListItemIcon sx={{ color: "white", minWidth: 40 }}>
                                                <ThreePIcon />
                                            </ListItemIcon>
                                    ...
                                    <ListItem disablePadding>
                                        <ListItemButton onClick={() => navigate("/clinicalAdminAttendance")}>
                                            <ListItemIcon sx={{ color: "white", minWidth: 40 }}>
                                                <ScheduleIcon />
                                            </ListItemIcon>

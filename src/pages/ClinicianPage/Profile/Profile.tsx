        ...
        <div>
            ...
            <div style={{ 
                ...
                <div style={{
                    ...
                    {/* School Information */}
                    <p style={{fontFamily: "Poppins, sans-serif", textAlign: "left", paddingLeft: "20px", paddingTop: "10px" , fontWeight: "500", fontSize: "16px", color: "#4b5563"}}>School Information</p>
                    <div style={{display: "flex", justifyContent: "space-between", alignItems: "center", backgroundColor: "#f3f4f6", padding: "8px 20px", margin: "8px 20px", borderRadius: "12px"}}>
                        <p style={{margin: 0, color: "#9ca3af"}}>Student Number</p> 
                        <p style={{margin: 0, color: "#2b2b2bff", fontWeight: "600"}}>{profile?.clinician?.student_number}</p>
                    </div>
                    <div style={{display: "flex", justifyContent: "space-between", alignItems: "center", backgroundColor: "#f3f4f6", padding: "8px 20px", margin: "8px 20px", borderRadius: "12px"}}>
                        <p style={{margin: 0, color: "#9ca3af"}}>Year Level</p> 
                        <p style={{margin: 0, color: "#2b2b2bff", fontWeight: "600"}}>{profile?.clinician?.year_level}</p>
                    </div>
                    <div style={{display: "flex", justifyContent: "space-between", alignItems: "center", backgroundColor: "#f3f4f6", padding: "8px 20px", margin: "8px 20px", borderRadius: "12px"}}>
                        <p style={{margin: 0, color: "#9ca3af"}}>Student Group</p> 
                        <p style={{margin: 0, color: "#2b2b2bff", fontWeight: "600"}}>{profile?.clinician?.student_groups?.group_name}</p>
                    </div>

...
export default function RequestDetails({ assignment, totalSeats, requestList }: RequestDetailsProps) {
...
return { bg: "#FFF3E0", bar: "#ED6C02", text: "#E65100", label: "Limited Capacity" };
    ...
    }, [currentPage, CARDS_PER_PAGE, sequentialChairsList]);
                ...
                <Box>
                    <Box
                        sx={{
                            ...
                            backgroundColor:
                                student.status === "Accepted" ? "#E8F5E9" :
                                    student.status === "Rejected" ? "#FFEBEE" :
                                        student.status === "Pending" ? "#FFF3E0" :
                                            "#EEEEEE",
                        }}
                    >
                        <Typography sx={{
                            ...
                            color:
                                student.status === "Accepted" ? "#2E7D32" :
                                    student.status === "Rejected" ? "#D32F2F" :
                                        student.status === "Pending" ? "#E65100" :
                                            "#616161"
                        }}>
                            {student.status}
                        </Typography>
                        ...
                        <Box>
                            {filteredRequestList.length > 0 ? (
                                ...
                                <Typography variant="body2" sx={{ textAlign: 'center', py: 4, backgroundColor: 'white', borderRadius: 2, border: '1px dashed #E0E0E0', color: "black" }}>
                                    No student requests found for this chair.
                                </Typography>
                            )}
                        </Box>
                    </Box>
...
// Extracted the repeating ChairFilterPanel purely to keep the return JSX clean.

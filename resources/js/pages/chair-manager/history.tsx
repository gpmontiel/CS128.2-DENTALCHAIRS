...
export default function RequestHistory({ history = [] }: PageProps) {
    ...
    return (
        <Box sx={{ fontFamily:"Inter", mx: 2 }}>
            <Box sx={{display: 'flex', alignItems: 'center', gap: 1, my: 2}}>
                <Button
                    startIcon={<ArrowLeft />}
                    onClick={() => router.get("/chair-manager/home")}
                    sx={{
                        textTransform: 'none',
                        color: '#493979',
                        minWidth: 'auto',
            ...
            <Box sx={{ mb: 3 }}>
                ...
                <Box>
                    {historyData.length === 0 ? (
                        <Typography sx={{ fontFamily:"Inter", color:"text.secondary", mb: 2, textAlign: 'center', width: '100%' }}>
                            No history yet
                        </Typography>
                    ) : filteredHistory.length === 0 ? (
                        <Typography sx={{ color:"text.secondary", fontFamily:"Inter", mb: 2, textAlign: 'center', width: '100%' }}>
